# uboot-extlinux-config-custom.bbclass
#
...
# UBOOT_EXTLINUX_FDTOVERLAYS       - Optional. Set to the path of the device
#                                    tree overlays to include in extlinux.conf.
#
...
python do_create_extlinux_config() {
    ...
    try:
        with open(cfile, 'w') as cfgfile:
            ...
            b = d.getVar("UBOOT_EXTLINUX_FDTOVERLAYS")
            bb.warn('start to write file: "%s"' % b)
...
UBOOT_EXTLINUX_VARS = "CONSOLE MENU_DESCRIPTION ROOT KERNEL_IMAGE FDTDIR FDT KERNEL_ARGS INITRD FDTOVERLAYS"
